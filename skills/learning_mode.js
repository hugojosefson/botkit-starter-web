...
module.exports = function (controller) {
  ...
  if (process.env.LEARNING_MODE == 'true') {
    ...
    console.log(
      '> This bot can modify itself! Disable learning mode in production!!'
    )
    console.log('--------------------------------------------')

    controller.studio.beforeThread('create_a_reply', 'confirmation', function (
      convo,
      next
    ) {
      // get original input
      ...
      controller.studio
        .createScript(convo.context.bot, trigger, text)
